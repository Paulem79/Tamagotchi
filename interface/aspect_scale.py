# Importé depuis internet, quelqu'un qui l'avait fait et c'était exactement ce dont on avait besoin pour afficher
# une image en gardant ses proportions
# Ne vous en occupez pas, c'est importé d'internet
